...
<li> Le dossier dataset: <br>
  contient le jeu de données <url src ="https://www.kaggle.com/datasets/uciml/pima-indians-diabetes-database"> "Pima_Indians_Diabetes"</url> provenant de kaggle</li>
